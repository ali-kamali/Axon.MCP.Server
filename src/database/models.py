...
class Repository(Base):
    ...
    github_repo_name = Column(String(255), index=True)
    github_repo_id = Column(BigInteger, index=True)
    ...
    __table_args__ = (
        ...
        Index("idx_repo_github_owner_repo", "github_owner", "github_repo_name"),
    )
