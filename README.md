...
git clone https://gitlab.example.org/axon/devops/axon.mcp.server.git
cd axon.mcp.server
...
### 🏗 Architecture
- [Overview](docs/architecture/overview.md) - System architecture and core components
- [Data Models](docs/architecture/data_models.md) - Database schema and relationships
- [Infrastructure](docs/architecture/infrastructure.md) - Deployment and scaling

### 📖 Guides
- [Setup Guide](docs/guides/setup.md) - Prerequisites and installation
- [Development Guide](docs/guides/development.md) - Dev environment setup and testing
- [Deployment Guide](docs/guides/deployment.md) - Docker and Kubernetes deployment
- [Security Guide](docs/guides/security.md) - Security features and best practices

### 🔌 API & Tools
- [REST API Reference](docs/api/rest_api.md) - API endpoints and usage
- [MCP Tools Reference](docs/api/mcp_tools.md) - MCP tools for AI assistants
